//
// Created by Thadd-PC on 10/21/2020.
//

#ifndef CS341PROJ3_PQUEUE_H
#define CS341PROJ3_PQUEUE_H
...
private:
    ...
    Node* copyTree(Node* toCopy);
    Node* mergeNodes(Node* firstNode, Node* secondNode);
    void printTree(Node* toPrint) const;
    void printNode(Node* toPrint) const;
};
